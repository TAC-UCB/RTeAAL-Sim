...
$(VERILOG_FILE_PATH):
	cp $(base_dir)/../verilogs/freechips.rocketchip.system.TwelveConfig.v $(base_dir)/$(MODEL).v

PLUSARGS_PATH = $(base_dir)/../verilogs/freechips.rocketchip.system.TwelveConfig.plusArgs

...
$(VERILOG_FILE_PATH):
	cp $(base_dir)/../verilogs/freechips.rocketchip.system.TwentyFourConfig.v $(base_dir)/$(MODEL).v

PLUSARGS_PATH = $(base_dir)/../verilogs/freechips.rocketchip.system.TwentyFourConfig.plusArgs

...
$(VERILOG_FILE_PATH):
	cp $(base_dir)/../verilogs/freechips.rocketchip.system.RocketLargeSHA3Config.v $(base_dir)/$(MODEL).v

PLUSARGS_PATH = $(base_dir)/../verilogs/freechips.rocketchip.system.RocketLargeSHA3Config.plusArgs
